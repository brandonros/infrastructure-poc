...
# restart deployment
kubectl rollout restart deployment -n microservice-poc1 microservice-poc1-app 
kubectl rollout restart deployment -n microservice-poc2 microservice-poc2-app 
